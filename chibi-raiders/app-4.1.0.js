...
const HEROES=[
 // C — COMUNS
 {id:"guarda",name:"Guarda da Fronteira",rarity:"C",color:"#FFFFFF",colorName:"Branco",img:"url_placeholder.png",emoji:"🛡️",class:"Guerreiro",position:"front",style:"melee",type:"physical",hp:1320,atk:150,def:150,speed:78,cr:.06,dg:.03,ult:{name:"Postura da Fronteira",kind:"aoe",ratio:.58,effect:"shield"}},
 {id:"acolito",name:"Acólito Aprendiz",rarity:"C",color:"#FFFFFF",colorName:"Branco",img:"url_placeholder.png",emoji:"📖",class:"Suporte",position:"back",style:"ranged",type:"magic",hp:900,atk:145,def:85,speed:96,cr:.04,dg:.06,ult:{name:"Prece Restauradora",kind:"heal",ratio:1.02,effect:"shield"}},
 {id:"batedor",name:"Batedor da Floresta",rarity:"C",color:"#FFFFFF",colorName:"Branco",img:"url_placeholder.png",emoji:"🏹",class:"Atirador",position:"back",style:"ranged",type:"physical",hp:930,atk:170,def:82,speed:110,cr:.10,dg:.10,ult:{name:"Flecha do Bosque",kind:"single",ratio:1.42,effect:"execute"}},

 // R — RAROS
 {id:"terra",name:"Guardião da Terra",rarity:"R",color:"#007BFF",colorName:"Azul",img:"url_placeholder.png",emoji:"🪨",class:"Tanque",position:"front",style:"melee",type:"physical",hp:2000,atk:200,def:220,speed:76,cr:.06,dg:.03,ult:{name:"Fortaleza Viva",kind:"aoe",ratio:.66,effect:"shield"}},
 {id:"espinho",name:"Espinho Rubro",rarity:"R",color:"#007BFF",colorName:"Azul",img:"url_placeholder.png",emoji:"🌹",class:"Guerreiro",position:"front",style:"melee",type:"physical",hp:1600,atk:250,def:150,speed:98,cr:.13,dg:.07,ult:{name:"Jardim Carmesim",kind:"aoe",ratio:.82,effect:"bleed"}},
 {id:"umbra",name:"Caçador Umbra",rarity:"R",color:"#007BFF",colorName:"Azul",img:"url_placeholder.png",emoji:"🌑",class:"Assassino",position:"back",style:"ranged",type:"physical",hp:1200,atk:280,def:110,speed:126,cr:.20,dg:.15,ult:{name:"Execução do Eclipse",kind:"single",ratio:2.05,effect:"execute"}},
 {id:"anao",name:"Canhoneiro Anão",rarity:"R",color:"#007BFF",colorName:"Azul",img:"url_placeholder.png",emoji:"💣",class:"Atirador",position:"back",style:"ranged",type:"physical",hp:1280,atk:270,def:120,speed:92,cr:.16,dg:.06,ult:{name:"Bombardeio Real",kind:"aoe",ratio:.90,effect:"pierce"}},
 {id:"aguas",name:"Irmã das Águas",rarity:"R",color:"#007BFF",colorName:"Azul",img:"url_placeholder.png",emoji:"💧",class:"Suporte",position:"back",style:"ranged",type:"magic",hp:1200,atk:245,def:120,speed:105,cr:.08,dg:.09,ult:{name:"Maré Serena",kind:"heal",ratio:1.28,effect:"shield"}},

 // EP — ÉPICOS
 {id:"quebra",name:"Quebra-Muros",rarity:"EP",color:"#8A2BE2",colorName:"Roxo",img:"url_placeholder.png",emoji:"🔨",class:"Tanque",position:"front",style:"melee",type:"physical",hp:2500,atk:275,def:285,speed:78,cr:.08,dg:.03,ult:{name:"Demolição Total",kind:"aoe",ratio:.78,effect:"break"}},
 {id:"relampago",name:"Lâmina Relâmpago",rarity:"EP",color:"#8A2BE2",colorName:"Roxo",img:"url_placeholder.png",emoji:"⚡",class:"Assassina",position:"front",style:"melee",type:"physical",hp:1450,atk:340,def:135,speed:140,cr:.23,dg:.16,ult:{name:"Mil Cortes",kind:"multi",ratio:.67,hits:5}},
 {id:"fada",name:"Fada das Lâminas",rarity:"EP",color:"#8A2BE2",colorName:"Roxo",img:"url_placeholder.png",emoji:"🧚",class:"Híbrida",position:"back",style:"ranged",type:"physical",hp:1350,atk:310,def:125,speed:132,cr:.19,dg:.18,ult:{name:"Tempestade Feérica",kind:"aoe",ratio:.80,effect:"haste"}},
 {id:"valquiria",name:"Valquíria de Gelo",rarity:"EP",color:"#8A2BE2",colorName:"Roxo",img:"url_placeholder.png",emoji:"❄️",class:"Guerreira",position:"front",style:"melee",type:"physical",hp:1850,atk:320,def:180,speed:110,cr:.14,dg:.09,ult:{name:"Inverno Eterno",kind:"aoeMagic",ratio:.88,effect:"freeze"}},
 {id:"barbanegra",name:"Barba-Negra, o Corsário",rarity:"EP",color:"#8A2BE2",colorName:"Roxo",img:"url_placeholder.png",emoji:"🏴‍☠️",class:"Atirador",position:"back",style:"ranged",type:"physical",hp:1650,atk:335,def:155,speed:102,cr:.18,dg:.08,ult:{name:"Salva do Abismo",kind:"aoe",ratio:.96,effect:"pierce"}},

 // SR — LENDÁRIOS
 {id:"crepusculo",name:"Senhor do Crepúsculo",rarity:"SR",color:"#FFA500",colorName:"Laranja",img:"url_placeholder.png",emoji:"🌘",class:"Mago",position:"back",style:"ranged",type:"magic",hp:1700,atk:420,def:180,speed:112,cr:.18,dg:.09,ult:{name:"Noite Sem Fim",kind:"aoeMagic",ratio:1.04,effect:"slow"}},
 {id:"seraphina",name:"Seraphina, a Suporte Divina",rarity:"SR",color:"#FFA500",colorName:"Laranja",img:"url_placeholder.png",emoji:"👼",class:"Suporte",position:"back",style:"ranged",type:"magic",hp:1800,atk:390,def:200,speed:114,cr:.10,dg:.10,ult:{name:"Aurora Celestial",kind:"heal",ratio:1.72,effect:"shield"}},
 {id:"ignis",name:"Ignis, o Piromante Louco",rarity:"SR",color:"#FFA500",colorName:"Laranja",img:"url_placeholder.png",emoji:"🔥",class:"Mago",position:"back",style:"ranged",type:"magic",hp:1650,atk:440,def:175,speed:118,cr:.20,dg:.08,ult:{name:"Supernova Insana",kind:"aoeMagic",ratio:1.12,effect:"bleed"}},
 {id:"aegis",name:"Aegis, o Escudo de Aço",rarity:"SR",color:"#FFA500",colorName:"Laranja",img:"url_placeholder.png",emoji:"🛡️",class:"Tanque",position:"front",style:"melee",type:"physical",hp:3100,atk:325,def:360,speed:84,cr:.09,dg:.04,ult:{name:"Bastião Absoluto",kind:"aoe",ratio:.82,effect:"shield"}},
 {id:"lyra",name:"Lyra, a Atiradora Espectral",rarity:"SR",color:"#FFA500",colorName:"Laranja",img:"url_placeholder.png",emoji:"🏹",class:"Atiradora",position:"back",style:"ranged",type:"physical",hp:1800,atk:430,def:190,speed:136,cr:.24,dg:.15,ult:{name:"Rajada Espectral",kind:"multi",ratio:.82,hits:5,effect:"haste"}},

 // SSR — MÍTICOS
 {id:"drako",name:"Drako, o Rei Dracônico",rarity:"SSR",color:"#FF0000",colorName:"Vermelho",img:"url_placeholder.png",emoji:"🐉",class:"Guerreiro Mítico",position:"front",style:"melee",type:"physical",hp:3800,atk:560,def:420,speed:128,cr:.24,dg:.10,ult:{name:"Imperador das Chamas Dracônicas",kind:"multi",ratio:1.02,hits:6,effect:"break"}},
 {id:"morgana",name:"Morgana, a Imperatriz do Vazio",rarity:"SSR",color:"#FF0000",colorName:"Vermelho",img:"url_placeholder.png",emoji:"🕳️",class:"Maga Mítica",position:"back",style:"ranged",type:"magic",hp:2900,atk:610,def:350,speed:148,cr:.28,dg:.16,ult:{name:"Horizonte do Vazio",kind:"aoeMagic",ratio:1.58,effect:"slow"}}
].map(buildHero);
