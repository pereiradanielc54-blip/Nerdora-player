const CACHE_NAME="nerdora-chibi-raiders-v4.1.0-identity";
const FALLBACK="./index-4.1.0.html";
const CORE=[
 "./index-4.1.0.html","./styles-4.1.0.css","./app-4.1.0.js",
 "./manifest.webmanifest","./version.json","./icon-192.webp","./icon-512.webp",
 "./assets/heroes/hero_atlas_20.webp",
 "./audio/menu-theme.wav","./audio/battle-theme.wav","./audio/ui-click.wav",
 "./audio/impact.wav","./audio/ultimate-ready.wav","./audio/ultimate-cast.wav","./audio/reward.wav"
];
