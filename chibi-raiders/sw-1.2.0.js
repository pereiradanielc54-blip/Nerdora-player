const CACHE_NAME="nerdora-chibi-raiders-v1.2.0";
const FALLBACK="./index-1.2.0.html";
const CORE=["./index-1.2.0.html","./styles-1.2.0.css","./app-1.2.0.js","./manifest.webmanifest","./version.json","./icon-192.webp","./icon-512.webp"];
