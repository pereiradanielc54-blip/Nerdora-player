const CACHE_NAME="nerdora-chibi-raiders-v1.0.0";
const FALLBACK="./index-1.0.0.html";
const CORE=["./index-1.0.0.html","./styles-1.0.0.css","./app-1.0.0.js","./manifest.webmanifest","./version.json","./icon.svg"];
