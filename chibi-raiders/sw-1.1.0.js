const CACHE_NAME="nerdora-chibi-raiders-v1.1.0";
const FALLBACK="./index-1.1.0.html";
const CORE=["./index-1.1.0.html","./styles-1.1.0.css","./app-1.1.0.js","./manifest.webmanifest","./version.json","./icon-192.webp","./icon-512.webp"];
