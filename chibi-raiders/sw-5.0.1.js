const CACHE_NAME="nerdora-chibi-raiders-v5.0.1-button-hotfix";
const FALLBACK="./index-5.0.1.html";
const CORE=[
 "./index-5.0.1.html",
 "./styles-5.0.1.css",
 "./app-5.0.1.js",
...
self.addEventListener("fetch",e=>{
 ...
 if(e.request.mode==="navigate"){
  ...
  if(stable){
   e.respondWith(caches.match(FALLBACK).then(c=>c||fetch(FALLBACK,{cache:"no-store"})));return;
  }
