        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    Text(
                        "Continue de onde parou e acesse o que importa sem repetir telas.",
            ...
            item {
                Row(
                    ...
                    CentralAction("Arquivos", "▣", Modifier.weight(1f), onOpenFiles)
                    CentralAction("Ajustes", "⚙", Modifier.weight(1f), onOpenSettings)
                }
            }
